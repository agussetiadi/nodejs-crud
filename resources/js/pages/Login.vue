		...
		<div class="login-box">
			...
			<div class="login-box-body">
				...
				<div class="form-group has-feedback" :class="{'has-error': errors.email}">
					<input type="email" name="" class="form-control" placeholder="Email" v-model="data.email">
					<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
					<p class="text-danger" v-if="errors.email">{{ errors.email[0] }}</p>
				</div>
				<div class="form-group has-feedback" :class="{'has-error': errors.password}">
					<input type="password" class="form-control" name="" placeholder="Password" v-model="data.password">
				...
				<div class="row">
					<div class="col-xs-8">
						<div class="checkbox">
							<label>
								<input type="checkbox" v-model="data.remember_me" name=""> Remember Me
							</label>
						</div>
					</div>
					<div class="col-xs-4">
						<button class="btn btn-primary btn-lock btn-flat" type="submit" @click.prevent="postLogin">Login</button>
					</div>
				</div>
